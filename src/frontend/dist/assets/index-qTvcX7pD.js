...
const ToggleRight = createLucideIcon("toggle-right", __iconNode$6);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const SEED_COMPETITIONS = [
  {
    ...
    description: "Premier powerlifting event in Mumbai featuring top athletes from across India. Sanctioned by IPF.",
  ...
  },
  {
    ...
    description: "Annual strength classic in the capital city. Open to all age categories.",
  ...
  },
  {
    ...
    description: "The biggest powerlifting meet in South India. All lifters welcome.",
  ...
  },
  {
    ...
    description: "Southern India powerlifting showcase. Raw and equipped divisions.",
  ...
  },
  {
    ...
    description: "Gujarat state level powerlifting competition. Prizes for top 3 in each category.",
  ...
  },
  {
    ...
    entryFee: 1300,
    weightCategories: ["74kg", "83kg", "93kg", "105kg", "120kg+"],
    description: "Open powerlifting meet welcoming lifters from all federations.",
...
const SEED_REVIEWS = [
  {
    ...
    rating: 5,
    comment: "Amazing event! Well organized with great equipment. Will definitely compete again.",
    createdAt: "2026-02-01"
  },
  {
    id: "r2",
...
const SEED_NOTIFICATIONS = [
  ...
  },
  {
    id: "n3",
    userId: "u2",
    message: "Your organizer account has been approved. You can now create competitions.",
    read: true,
...
const useStore = create((set, get) => {
  initSeedData();
  const users = loadFromStorage("pl_users", SEED_USERS);
  const competitions = loadFromStorage(
    "pl_competitions",
    SEED_COMPETITIONS
  );
  const reviews = loadFromStorage("pl_reviews", SEED_REVIEWS);
  ...
  return {
    ...
    login: (phone) => {
      const users2 = loadFromStorage("pl_users", SEED_USERS);
      const user = users2.find((u) => u.phone === phone) ?? null;
      if (user) {
        localStorage.setItem("pl_current_user", JSON.stringify(user));
        set({ currentUser: user, users: users2 });
      }
      return user;
    },
    logout: () => {
    ...
    updateProfile: (updates) => {
      const { currentUser: currentUser2, users: users2 } = get();
      if (!currentUser2) return;
      const updated = users2.map(
        (u) => u.id === currentUser2.id ? { ...u, ...updates } : u
      );
      saveToStorage("pl_users", updated);
      const newCurrent = { ...currentUser2, ...updates };
      localStorage.setItem("pl_current_user", JSON.stringify(newCurrent));
      set({ users: updated, currentUser: newCurrent });
    },
    createCompetition: (data) => {
      const comps = loadFromStorage(
        "pl_competitions",
        SEED_COMPETITIONS
      );
      const newComp = {
    ...
    joinCompetition: (id) => {
      const { currentUser: currentUser2 } = get();
      if (!currentUser2) return;
      const comps = loadFromStorage(
        "pl_competitions",
        SEED_COMPETITIONS
      ...
      const updated = comps.map(
        (c) => c.id === id && !c.participants.includes(currentUser2.id) ? { ...c, participants: [...c.participants, currentUser2.id] } : c
      );
      saveToStorage("pl_competitions", updated);
      set({ competitions: updated });
    },
    addReview: (competitionId, rating, comment) => {
      const { currentUser: currentUser2 } = get();
      if (!currentUser2) return;
      const reviews2 = loadFromStorage("pl_reviews", SEED_REVIEWS);
      const newReview = {
        id: `r${Date.now()}`,
        competitionId,
        userId: currentUser2.id,
        userName: currentUser2.name,
        rating,
        comment,
        createdAt: (/* @__PURE__ */ new Date()).toISOString().split("T")[0]
      };
      const updated = [...reviews2, newReview];
    ...
    approveOrganizer: (userId) => {
      const users2 = loadFromStorage("pl_users", SEED_USERS);
      const updated = users2.map(
        (u) => u.id === userId ? { ...u, approved: true } : u
      );
      saveToStorage("pl_users", updated);
      set({ users: updated });
      get().addNotification(
    ...
    rejectOrganizer: (userId) => {
      const users2 = loadFromStorage("pl_users", SEED_USERS);
      const updated = users2.filter((u) => u.id !== userId);
      saveToStorage("pl_users", updated);
      set({ users: updated });
    },
    deleteUser: (userId) => {
    ...
    toggleFeatured: (id) => {
      ...
      const updated = comps.map(
        (c) => c.id === id ? { ...c, featured: !c.featured } : c
      );
      saveToStorage("pl_competitions", updated);
      set({ competitions: updated });
    },
    ...
    refreshFromStorage: () => {
      set({
        users: loadFromStorage("pl_users", SEED_USERS),
        competitions: loadFromStorage(
          "pl_competitions",
          SEED_COMPETITIONS
        ),
        reviews: loadFromStorage("pl_reviews", SEED_REVIEWS),
...
function Layout({ children }) {
  const { currentUser, navigate, logout, notifications, currentPage } = useStore();
  const [menuOpen, setMenuOpen] = reactExports.useState(false);
  const [userMenuOpen, setUserMenuOpen] = reactExports.useState(false);
  const unread = notifications.filter(
    (n) => n.userId === (currentUser == null ? void 0 : currentUser.id) && !n.read
  ).length;
      ...
      children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 h-16 flex items-center justify-between", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 24, style: { color: "#E4572E" } }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden md:flex items-center gap-6", children: NAV_LINKS.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "div",
                              {
                                ...
                                style: { backgroundColor: "#E4572E" },
                                children: currentUser.name[0].toUpperCase()
                              }
                            ),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden md:block text-sm", children: currentUser.name.split(" ")[0] }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { size: 14, className: "text-gray-400" })
                          ]
                        }
                      ),
                      userMenuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx("hr", { style: { borderColor: "#2A2F36" }, className: "my-1" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "button",
                              {
                                onClick: () => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "footer",
          {
            ...
            className: "mt-16",
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 py-10", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-8 mb-8", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-2 md:col-span-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 20, style: { color: "#E4572E" } }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-heading text-lg", children: "POWERLIFT" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "#A7AFB9" }, children: "India's premier powerlifting competition platform." })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-sm mb-3", children: "Platform" }),
                  ["Competitions", "Find Events", "Host a Meet"].map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-sm mb-3", children: "Account" }),
                  ["Register", "Login", "Profile"].map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      className: "text-sm mb-2",
                      style: { color: "#A7AFB9" },
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-sm mb-3", children: "Legal" }),
                  ["Privacy Policy", "Terms of Use", "Contact"].map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      className: "text-sm mb-2",
                      style: { color: "#A7AFB9" },
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: "© 2026 PowerLift Platform. All rights reserved."
                }
              )
            ] })
          }
...
function AdminPanel() {
  ...
  const [compSearch, setCompSearch] = reactExports.useState("");
  if (!currentUser || currentUser.role !== "admin") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-heading text-2xl mb-4", children: "ACCESS RESTRICTED" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          onClick: () => navigate("/login"),
  ...
  const filteredUsers = users.filter(
    (u) => !userSearch || u.name.toLowerCase().includes(userSearch.toLowerCase()) || u.phone.includes(userSearch)
  );
  const filteredComps = competitions.filter(
    (c) => !compSearch || c.name.toLowerCase().includes(compSearch.toLowerCase())
  );
  const TABS = [
    { id: "overview", label: "Overview", icon: ChartNoAxesColumn },
    { id: "users", label: "Users", icon: Users },
    { id: "organizers", label: "Organizers", icon: CircleCheckBig },
    { id: "competitions", label: "Competitions", icon: Trophy }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 py-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "#A7AFB9" }, children: "Admin Panel" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-heading text-3xl", children: [
        "CONTROL ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#E4572E" }, children: "CENTER" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 flex-wrap mb-8", children: TABS.map(({ id, label, icon: Icon2 }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        onClick: () => setTab(id),
        ...
        style: {
          ...
          backgroundColor: tab === id ? "rgba(228,87,46,0.15)" : "transparent",
        ...
        children: [
          ...
          " ",
          label,
          id === "organizers" && pendingOrgs.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
    ...
    tab === "overview" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4 mb-8", children: [
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-heading text-4xl", style: { color }, children: value }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-1", style: { color: "#A7AFB9" }, children: label })
          ]
        },
        label
      )) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: { backgroundColor: "#1B1E22", borderColor: "#2A2F36" },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-heading text-lg mb-4", children: "COMPETITIONS BY STATE" }),
              [...new Set(competitions.map((c) => c.state))].map((state) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-xs mb-1", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#A7AFB9" }, children: count })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: { backgroundColor: "#1B1E22", borderColor: "#2A2F36" },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-heading text-lg mb-4", children: "RECENT ACTIVITY" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: competitions.slice(-5).reverse().map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 text-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "truncate", children: c.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
    ...
    tab === "users" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm", style: { color: "#A7AFB9" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { style: { backgroundColor: "#20242A" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: ["Name", "Phone", "Role", "Status", ""].map((h) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "th",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: filteredUsers.map((u) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { style: { borderTop: "1px solid #2A2F36" }, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-4 py-3", style: { color: "#A7AFB9" }, children: [
                "+91 ",
                u.phone
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  style: {
                    backgroundColor: u.role === "admin" ? "rgba(228,87,46,0.2)" : u.role === "organizer" ? "rgba(214,161,74,0.2)" : "rgba(74,222,128,0.2)",
                    color: u.role === "admin" ? "#E4572E" : u.role === "organizer" ? "#D6A14A" : "#4ade80"
                  },
                  children: u.role
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  children: u.approved ? "Active" : "Pending"
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: u.role !== "admin" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  onClick: () => deleteUser(u.id),
                  className: "p-1.5 rounded-lg hover:bg-red-900/30",
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { size: 13, className: "text-red-400" })
                }
              ) })
            ] }, u.id)) })
          ] })
    ...
    tab === "organizers" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
      pendingOrgs.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-heading text-xl mb-4", children: [
          "PENDING APPROVAL",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: "#f87171" }, children: [
            "(",
            pendingOrgs.length,
            ")"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: pendingOrgs.map((u) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-sm", children: u.orgName }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs", style: { color: "#A7AFB9" }, children: [
                  u.name,
                  " • +91 ",
                  u.phone
                ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          approvedOrgs.map((u) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "rounded-2xl border p-4 flex flex-wrap items-center justify-between gap-3",
              style: { backgroundColor: "#1B1E22", borderColor: "#2A2F36" },
          ...
          approvedOrgs.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "#A7AFB9" }, children: "No approved organizers" })
        ] })
      ] })
    ] }),
    tab === "competitions" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: filteredComps.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "rounded-2xl border p-4 flex flex-wrap items-center justify-between gap-3",
          style: { backgroundColor: "#1B1E22", borderColor: "#2A2F36" },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap mb-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-sm", children: c.name }),
                ...
                !c.active && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: "text-xs px-1.5 py-0.5 rounded",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  title: "Toggle active",
                  className: "p-1.5 rounded-lg hover:bg-white/10",
                  children: c.active ? /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleRight, { size: 16, style: { color: "#4ade80" } }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleLeft, { size: 16, style: { color: "#A7AFB9" } })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  className: "p-1.5 rounded-lg hover:bg-red-900/30",
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { size: 14, className: "text-red-400" })
                }
              )
            ] })
          ]
...
function CompetitionDetail({ id }) {
  ...
  const compReviews = reviews.filter((r2) => r2.competitionId === id);
  const avgRating = compReviews.length ? (compReviews.reduce((s, r2) => s + r2.rating, 0) / compReviews.length).toFixed(1) : null;
  const [rating, setRating] = reactExports.useState(5);
  const [comment, setComment] = reactExports.useState("");
  const [submitted, setSubmitted] = reactExports.useState(false);
  if (!competition)
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-heading text-2xl", children: "COMPETITION NOT FOUND" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          style: { color: "#E4572E" },
          children: "Back to Competitions"
        }
      )
    ] });
  const whatsappUrl = `https://wa.me/${competition.contactNumber}?text=Hi, I want to join ${encodeURIComponent(competition.name)}`;
  const hasReviewed = compReviews.some((r2) => r2.userId === (currentUser == null ? void 0 : currentUser.id));
  const isParticipant = currentUser ? competition.participants.includes(currentUser.id) : false;
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: competition.featured && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", style: { backgroundColor: "#1B1E22" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-heading text-3xl mb-4", children: competition.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 gap-3", children: metaRows.map(({ icon: Icon2, text, color }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 16, style: { color } }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#F2F4F7" }, children: text })
            ] }, text)) })
          ] })
        ]
      }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2 space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: { backgroundColor: "#1B1E22", borderColor: "#2A2F36" },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-heading text-lg mb-3", children: "ABOUT THIS EVENT" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm leading-relaxed", style: { color: "#A7AFB9" }, children: competition.description })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: { backgroundColor: "#1B1E22", borderColor: "#2A2F36" },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-heading text-lg mb-3", children: "WEIGHT CATEGORIES" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: competition.weightCategories.map((w) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-heading text-lg", children: "REVIEWS" }),
                avgRating && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 16, style: { color: "#D6A14A" }, fill: "#D6A14A" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold", children: avgRating }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs", style: { color: "#A7AFB9" }, children: [
                    "(",
                    compReviews.length,
                    ")"
                  ] })
              ...
              compReviews.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "#A7AFB9" }, children: "No reviews yet." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: compReviews.map((r2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold", children: r2.userName }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex", children: [1, 2, 3, 4, 5].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Star,
                        {
                          size: 12,
                          style: {
                            color: s <= r2.rating ? "#D6A14A" : "#2A2F36"
                          },
                          fill: s <= r2.rating ? "#D6A14A" : "none"
                        },
                        s
                      )) })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "#A7AFB9" }, children: r2.comment })
                  ]
                },
                r2.id
              )) }),
              (currentUser == null ? void 0 : currentUser.role) === "player" && !hasReviewed && !submitted && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: "mt-4 pt-4 border-t",
                  style: { borderColor: "#2A2F36" },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold mb-3", children: "Add Your Review" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 mb-3", children: [1, 2, 3, 4, 5].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setRating(s), children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Star,
                      {
                        size: 20,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: { backgroundColor: "#1B1E22", borderColor: "#2A2F36" },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mb-1", style: { color: "#A7AFB9" }, children: "Entry Fee" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "p",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm mb-4", style: { color: "#A7AFB9" }, children: [
              ...
              (currentUser == null ? void 0 : currentUser.role) === "player" && !isParticipant && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  onClick: () => joinCompetition(id),
                  className: "w-full mt-2 py-2.5 rounded-xl text-sm border hover:bg-white/10",
                  style: { borderColor: "#2A2F36" },
                  children: "Mark as Interested"
                }
              )
            ]
          }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: { backgroundColor: "#1B1E22", borderColor: "#2A2F36" },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-sm mb-3", children: "Location" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
...
function CompetitionCard({ competition, onDetails }) {
  const { navigate, currentUser } = useStore();
  const gradient = GRADIENTS[competition.gradientIndex % GRADIENTS.length];
  const whatsappUrl = `https://wa.me/${competition.contactNumber}?text=Hi, I want to join ${encodeURIComponent(competition.name)}`;
  const isUpcoming = new Date(competition.date) >= /* @__PURE__ */ new Date();
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              competition.featured && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex flex-col flex-1 gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                style: { color: "#A7AFB9" },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 12, style: { color: "#E4572E" } }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                style: { color: "#A7AFB9" },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { size: 12, style: { color: "#E4572E" } }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: new Date(competition.date).toLocaleDateString("en-IN", {
                    day: "numeric",
                    month: "short",
                    year: "numeric"
                  }) })
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                style: { color: "#A7AFB9" },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(DollarSign, { size: 12, style: { color: "#D6A14A" } }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                    "₹",
                    competition.entryFee.toLocaleString(),
                    " entry fee"
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                style: { color: "#A7AFB9" },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(User, { size: 12, style: { color: "#A7AFB9" } }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: competition.organizerName })
                ]
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-1 mt-1", children: [
            competition.weightCategories.slice(0, 3).map((w) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: "text-xs px-2 py-0.5 rounded-full",
            ...
            competition.weightCategories.length > 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "span",
              {
                className: "text-xs px-2 py-0.5 rounded-full",
                style: { backgroundColor: "#2A2F36", color: "#A7AFB9" },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              style: { color: "#A7AFB9" },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 11, style: { color: "#D6A14A" }, fill: "#D6A14A" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                  competition.participants.length,
                  " athletes registered"
                ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 mt-auto pt-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                onClick: () => onDetails ? onDetails() : navigate(`/competitions/${competition.id}`),
                className: "flex-1 text-xs py-2 rounded-lg border hover:bg-white/5 transition-colors",
                style: { borderColor: "#2A2F36" },
                children: "View Details"
              }
            ),
            (currentUser == null ? void 0 : currentUser.role) === "player" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                href: whatsappUrl,
                target: "_blank",
...
const FILTER_TABS$1 = ["All", "Upcoming", "This Month", "Featured"];
function CompetitionsPage() {
  ...
  const cities = [
    ...new Set(
      competitions.filter((c) => !selectedState || c.state === selectedState).map((c) => c.city)
    )
  ].sort();
  ...
  const filtered = reactExports.useMemo(() => {
    return competitions.filter((c) => {
      ...
      const matchTab = activeTab === "All" ? true : activeTab === "Upcoming" ? compDate >= now2 : activeTab === "This Month" ? compDate >= now2 && compDate <= endOfMonth : activeTab === "Featured" ? c.featured : true;
      return matchSearch && matchState && matchCity && matchTab;
    });
  }, [competitions, search, selectedState, selectedCity, activeTab]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 py-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-heading text-4xl mb-2", children: [
        "ALL ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#E4572E" }, children: "COMPETITIONS" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "#A7AFB9" }, children: "Discover powerlifting events across India" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { size: 16, style: { color: "#A7AFB9" } }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    value: search,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SlidersHorizontal, { size: 14, style: { color: "#A7AFB9" } }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", style: { color: "#A7AFB9" }, children: "Filter:" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "select",
              {
            ...
            (selectedState || selectedCity || search) && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                onClick: () => {
                  setSelectedState("");
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: FILTER_TABS$1.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              style: {
                ...
                backgroundColor: activeTab === tab ? "rgba(228,87,46,0.15)" : "transparent",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2 mb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm", style: { color: "#A7AFB9" }, children: [
      filtered.length,
      " competition",
      filtered.length !== 1 ? "s" : "",
      " found"
    ] }) }),
    filtered.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5", children: filtered.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      CompetitionCard,
      {
        competition: c,
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-heading text-xl mb-2", children: "NO COMPETITIONS FOUND" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "#A7AFB9" }, children: "Try adjusting your filters" })
        ]
      }
    )
  ] });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        style: {
          background: "linear-gradient(135deg, #0E0F10 0%, #1a0800 40%, #0E0F10 100%)"
        },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "radial-gradient(ellipse at 30% 50%, rgba(228,87,46,0.15) 0%, transparent 60%)"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative max-w-7xl mx-auto px-4 py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  " India's #1 Powerlifting Platform"
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-heading text-5xl md:text-7xl leading-none mb-4", children: [
              "DOMINATE THE ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#E4572E" }, children: "PLATFORM" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg mb-8", style: { color: "#A7AFB9" }, children: "Discover powerlifting competitions near you. Register, compete, and rise to the top." }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: { borderColor: "#2A2F36" },
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: [
                    ...
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 20, style: { color: "#E4572E" } }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-heading text-xl", children: value }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "#A7AFB9" }, children: label })
                        ] })
                      ]
                    },
                    label
    ...
    featured.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-7xl mx-auto px-4 py-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-heading text-3xl", children: [
            "FEATURED ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#E4572E" }, children: "COMPETITIONS" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-1", style: { color: "#A7AFB9" }, children: "Highlighted events from top organizers" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5", children: featured.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(CompetitionCard, { competition: c }, c.id)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-heading text-3xl text-center mb-12", children: [
            "HOW IT ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#E4572E" }, children: "WORKS" })
          ] }),
          ...
          ].map(({ step, title, desc }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-heading text-xl mb-2", children: title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "#A7AFB9" }, children: desc })
              ]
            },
            step
          )) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "max-w-7xl mx-auto px-4 py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "rounded-2xl p-10 text-center",
        style: {
          background: "linear-gradient(135deg, rgba(228,87,46,0.2) 0%, rgba(214,161,74,0.1) 100%)",
          border: "1px solid rgba(228,87,46,0.3)"
        },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-heading text-4xl mb-3", children: [
            "READY TO ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#E4572E" }, children: "COMPETE?" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-6", style: { color: "#A7AFB9" }, children: "Join thousands of powerlifters across India." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: () => navigate("/register"),
...
function Login() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-[80vh] flex items-center justify-center px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 28, style: { color: "#E4572E" } })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-heading text-3xl", children: "WELCOME BACK" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-2", style: { color: "#A7AFB9" }, children: "Login to your PowerLift account" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        style: { backgroundColor: "#1B1E22", borderColor: "#2A2F36" },
        children: step === "phone" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "label",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                style: { borderColor: "#2A2F36", backgroundColor: "#20242A" },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 16, style: { color: "#A7AFB9" } }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", style: { color: "#A7AFB9" }, children: "+91" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      id: "phone-input",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-center", style: { color: "#A7AFB9" }, children: [
            "Demo phones:",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono", style: { color: "#E4572E" }, children: "0000000000" }),
            " ",
            "(admin),",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono", style: { color: "#E4572E" }, children: "1111111111" }),
            " ",
            "(organizer),",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono", style: { color: "#E4572E" }, children: "2222222222" }),
            " ",
            "(player)"
          ] })
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-1", style: { color: "#A7AFB9" }, children: "Enter any 6-digit code to continue" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center text-sm mt-4", style: { color: "#A7AFB9" }, children: [
...
function NotificationsPage() {
  const { currentUser, notifications, markNotificationRead, navigate } = useStore();
  if (!currentUser) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: () => navigate("/login"),
        className: "px-6 py-2 rounded-xl",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-4 py-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-heading text-3xl", children: "NOTIFICATIONS" }),
        unread.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm mt-1", style: { color: "#A7AFB9" }, children: [
          unread.length,
          " unread"
        ] })
      ] }),
    ...
    myNotifs.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "text-center py-20 rounded-2xl border",
        style: { borderColor: "#2A2F36", backgroundColor: "#1B1E22" },
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-heading text-xl", children: "NO NOTIFICATIONS" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-2", style: { color: "#A7AFB9" }, children: "You're all caught up!" })
        ]
      }
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: myNotifs.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: n.message }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-1", style: { color: "#A7AFB9" }, children: new Date(n.createdAt).toLocaleDateString("en-IN", {
              day: "numeric",
              month: "short",
              year: "numeric"
            }) })
...
function OrganizerPanel() {
  ...
  const [participantsModal, setParticipantsModal] = reactExports.useState(null);
  const [error, setError] = reactExports.useState("");
  ...
  if (!currentUser.approved) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-lg mx-auto px-4 py-20 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-heading text-2xl mb-3", children: "PENDING APPROVAL" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "#A7AFB9" }, children: "Your organizer account is under review. You'll be notified once approved by the admin." })
        ]
      }
    ) });
  }
  ...
  const toggleWeight = (w) => {
    setForm((f) => ({
      ...f,
      weightCategories: f.weightCategories.includes(w) ? f.weightCategories.filter((x) => x !== w) : [...f.weightCategories, w]
    }));
  };
  const handleSubmit = () => {
    if (!form.name.trim() || !form.state || !form.city || !form.date || !form.entryFee || !form.contactNumber) {
  ...
  const participants = participantsModal ? users.filter((u) => participantsModal.participants.includes(u.id)) : [];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 py-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "#A7AFB9" }, children: "Welcome," }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-heading text-3xl", children: (currentUser.orgName || currentUser.name).toUpperCase() })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 mb-6", children: ["list", "create"].map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: () => {
          setTab(t);
        ...
        style: {
          ...
          backgroundColor: tab === t ? "rgba(228,87,46,0.15)" : "transparent",
          color: tab === t ? "#E4572E" : "#A7AFB9"
        },
        children: t === "list" ? "My Competitions" : editId ? "Edit Competition" : "Create New"
      },
      t
    )) }),
    tab === "list" ? myComps.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "text-center py-20 rounded-2xl border",
        style: { borderColor: "#2A2F36", backgroundColor: "#1B1E22" },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-heading text-xl mb-2", children: "NO COMPETITIONS YET" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mb-4", style: { color: "#A7AFB9" }, children: "Create your first competition" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
    ...
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: myComps.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "rounded-2xl border p-4 flex flex-wrap items-center justify-between gap-3",
        style: { backgroundColor: "#1B1E22", borderColor: "#2A2F36" },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs mt-1", style: { color: "#A7AFB9" }, children: [
              c.city,
              ", ",
              c.state,
              " •",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(SquarePen, { size: 14, style: { color: "#A7AFB9" } })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
      ...
      "div",
      {
        ...
        style: { backgroundColor: "#1B1E22", borderColor: "#2A2F36" },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-heading text-xl mb-6", children: editId ? "EDIT COMPETITION" : "CREATE COMPETITION" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "label",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: "text-xs font-medium block mb-1.5",
                  style: { color: "#A7AFB9" },
                  children: "Weight Categories"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: WEIGHT_OPTIONS.map((w) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  ...
                  style: {
                    borderColor: form.weightCategories.includes(w) ? "#E4572E" : "#2A2F36",
                    backgroundColor: form.weightCategories.includes(w) ? "rgba(228,87,46,0.15)" : "transparent",
                    color: form.weightCategories.includes(w) ? "#E4572E" : "#A7AFB9"
                  },
                  children: w
                },
                w
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  style: { backgroundColor: "#E4572E", color: "#fff" },
                  children: editId ? "Update" : "Create Competition"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
    ...
    participantsModal && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-black/70 flex items-center justify-center z-50 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-heading text-lg", children: "PARTICIPANTS" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setParticipantsModal(null), children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 18, style: { color: "#A7AFB9" } }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mb-4", style: { color: "#A7AFB9" }, children: participantsModal.name }),
          participants.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
          ...
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: participants.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", children: p.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs", style: { color: "#A7AFB9" }, children: [
                    "+91 ",
                    p.phone
                  ] })
...
function PlayerDashboard() {
  ...
  const filtered = reactExports.useMemo(() => {
    ...
    return competitions.filter((c) => {
      ...
      const matchCity = !selectedCity || c.city === selectedCity;
      const compDate = new Date(c.date);
      const matchTab = activeTab === "All" ? true : activeTab === "Upcoming" ? compDate >= now2 : activeTab === "This Month" ? compDate >= now2 && compDate <= endOfMonth : activeTab === "Featured" ? c.featured : activeTab === "My Registrations" ? c.participants.includes(currentUser.id) : true;
      return matchSearch && matchState && matchCity && matchTab;
    });
  }, [
    competitions,
  ...
  const myRegistrations = competitions.filter(
    (c) => c.participants.includes(currentUser.id)
  );
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 py-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mb-1", style: { color: "#A7AFB9" }, children: "Welcome back," }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-heading text-4xl", children: currentUser.name.toUpperCase() })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4 mb-8", children: [
      {
    ...
    ].map(({ label, value, Icon: Icon2, color }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "rounded-2xl border p-4",
        style: { backgroundColor: "#1B1E22", borderColor: "#2A2F36" },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 20, style: { color }, className: "mb-2" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-heading text-2xl", children: value }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "#A7AFB9" }, children: label })
        ]
      },
      label
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 flex-wrap", children: FILTER_TABS.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: () => setActiveTab(tab),
              className: "text-xs px-4 py-1.5 rounded-full border transition-all",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-heading text-xl", children: [
      "COMPETITIONS",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: "#E4572E" }, children: [
        "(",
        filtered.length,
        ")"
      ] })
...
function ProfilePage() {
  ...
  const save = () => {
    updateProfile({
      ...
      orgName: orgName.trim() || void 0
    });
    setEditing(false);
  };
  const myComps = currentUser.role === "player" ? competitions.filter((c) => c.participants.includes(currentUser.id)) : competitions.filter((c) => c.organizerId === currentUser.id);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-4 py-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-heading text-3xl mb-8", children: [
      "MY ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#E4572E" }, children: "PROFILE" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-heading text-xl", children: currentUser.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: "text-xs px-2 py-0.5 rounded-full capitalize",
                ...
                currentUser.role === "organizer" && !currentUser.approved && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
          ...
          editing ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            ...
            currentUser.role === "organizer" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "label",
                {
                  htmlFor: "edit-org",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(InfoRow, { icon: User, label: "Full Name", value: currentUser.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              InfoRow,
              {
                icon: Phone,
            ...
            currentUser.orgName && /* @__PURE__ */ jsxRuntimeExports.jsx(
              InfoRow,
              {
                icon: Building,
                label: "Organization",
    ...
    myComps.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "rounded-2xl border p-6",
        style: { backgroundColor: "#1B1E22", borderColor: "#2A2F36" },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-heading text-lg mb-4", children: currentUser.role === "player" ? "MY REGISTRATIONS" : "MY COMPETITIONS" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: myComps.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", children: c.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs", style: { color: "#A7AFB9" }, children: [
                    c.city,
                    " •",
                    " ",
...
function InfoRow({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 16, style: { color: "#A7AFB9" } }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "#A7AFB9" }, children: label }),
...
function Register() {
  ...
  const [role, setRole] = reactExports.useState("player");
  const [name, setName] = reactExports.useState("");
  const [phone, setPhone] = reactExports.useState("");
  const [orgName, setOrgName] = reactExports.useState("");
  const [error, setError] = reactExports.useState("");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-[80vh] flex items-center justify-center px-4 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-heading text-3xl", children: "JOIN POWERLIFT" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-2", style: { color: "#A7AFB9" }, children: "Create your account to get started" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium block mb-2", children: "I am a" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: ["player", "organizer"].map((r2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                onClick: () => setRole(r2),
                className: "py-3 rounded-xl text-sm font-semibold border-2 transition-all capitalize",
                style: {
                  borderColor: role === r2 ? "#E4572E" : "#2A2F36",
                  backgroundColor: role === r2 ? "rgba(228,87,46,0.1)" : "transparent",
                  color: role === r2 ? "#E4572E" : "#A7AFB9"
                },
                children: r2
              },
              r2
          ...
          role === "organizer" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "label",
              {
                htmlFor: "org-name",
                className: "text-sm font-medium block mb-2",
                children: "Competition / Organization Name"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                style: { borderColor: "#2A2F36", backgroundColor: "#20242A" },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Building, { size: 16, style: { color: "#A7AFB9" } }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      id: "org-name",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "label",
              {
                htmlFor: "full-name",
                className: "text-sm font-medium block mb-2",
                children: role === "organizer" ? "Organizer Name" : "Full Name"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                style: { borderColor: "#2A2F36", backgroundColor: "#20242A" },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(User, { size: 16, style: { color: "#A7AFB9" } }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      id: "full-name",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              className: "w-full py-3 rounded-xl font-semibold text-sm disabled:opacity-60",
              style: { backgroundColor: "#E4572E", color: "#fff" },
              children: loading ? "Creating Account..." : `Register as ${role === "player" ? "Player" : "Organizer"}`
            }
          ),
          role === "organizer" && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-center", style: { color: "#A7AFB9" }, children: "Organizer accounts require admin approval before you can create competitions." })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center text-sm mt-4", style: { color: "#A7AFB9" }, children: [
...
function App() {
  ...
  const renderPage = () => {
    if (currentPage === "/") return /* @__PURE__ */ jsxRuntimeExports.jsx(Home, {});
    if (currentPage === "/login") return /* @__PURE__ */ jsxRuntimeExports.jsx(Login, {});
    if (currentPage === "/register") return /* @__PURE__ */ jsxRuntimeExports.jsx(Register, {});
    if (currentPage === "/competitions") return /* @__PURE__ */ jsxRuntimeExports.jsx(CompetitionsPage, {});
    if (currentPage.startsWith("/competitions/")) {
      const id = currentPage.replace("/competitions/", "");
      return /* @__PURE__ */ jsxRuntimeExports.jsx(CompetitionDetail, { id });
    }
    if (currentPage === "/dashboard") return /* @__PURE__ */ jsxRuntimeExports.jsx(PlayerDashboard, {});
    if (currentPage === "/organizer") return /* @__PURE__ */ jsxRuntimeExports.jsx(OrganizerPanel, {});
    if (currentPage === "/admin") return /* @__PURE__ */ jsxRuntimeExports.jsx(AdminPanel, {});
    if (currentPage === "/profile") return /* @__PURE__ */ jsxRuntimeExports.jsx(ProfilePage, {});
    if (currentPage === "/notifications") return /* @__PURE__ */ jsxRuntimeExports.jsx(NotificationsPage, {});
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Home, {});
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: renderPage() });
}
